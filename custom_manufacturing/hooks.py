...
fixtures = [{'doctype': 'Address Template', 'filters': [{'name': 'Latvia'}]}, {'doctype': 'Print Format', 'filters': [{'name': 'Project Offer'}]},{'doctype': 'Custom Script', 'filters': [['name', 'in',['Quotation-Client', 'Quotation Item-Client', 'Project Offer-Client', 'BOM-Client', 'Item-Client', 'Customer-Client', 'Multi Doctype Tree Manager-Client', 'Stock Entry-Client', 'Item Price-Client','Stock Reconciliation-Client']]]}, {'doctype': 'Custom Field', 'filters': [['dt', 'in',['BOM', 'BOM Item', 'Quotation', 'Quotation Item', 'Item', 'Customer', 'Address', 'Contact', 'Item Group', 'Quotation Master BOM', 'Item Price', 'Stock Entry Detail', 'Purchase Order Item', 'Stock Reconciliation', 'Stock Reconciliation Item']]]}, {'doctype': 'Property Setter', 'filters': [['doc_type', 'in',['BOM', 'BOM Item', 'Quotation', 'Quotation Item', 'Item', 'Customer', 'Address', 'Contact', 'Item Group', 'Quotation Master BOM', 'Item Price', 'Stock Entry Detail', 'Purchase Order Item', 'Stock Reconciliation', 'Stock Reconciliation Item']]]}, ]
